...
const styles: any = {
  ...
  viewButton: { padding: '10px 16px', backgroundColor: 'var(--success-color)', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', marginRight: '8px', fontSize: '13px', fontWeight: 600, transition: 'all 0.2s ease', boxShadow: '0 4px 12px rgba(39, 174, 96, 0.3)' },
